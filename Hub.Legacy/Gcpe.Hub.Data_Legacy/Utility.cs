...
namespace Gcpe.Hub
{
    public static class Utility
    {
        ...
        public static DateTime GetPacificDateTimeNow()
        {
            return GetPacificDateTime(DateTimeOffset.UtcNow);
        }

        public static DateTime GetPacificDateTime(DateTimeOffset dateTimeOffset)
        {
            var pacificTimeZone = TimeZoneInfo.FindSystemTimeZoneById("Pacific Standard Time");

            var pacificNow = TimeZoneInfo.ConvertTime(dateTimeOffset.DateTime, TimeZoneInfo.Utc, pacificTimeZone);
