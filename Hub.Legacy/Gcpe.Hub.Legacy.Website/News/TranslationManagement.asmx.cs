...
{
    /// <summary>
    /// Summary description for TranslationManagement
    /// </summary>
    [WebService(Namespace = "http://tempuri.org/")]
    [WebServiceBinding(ConformsTo = WsiProfiles.BasicProfile1_1)]
    [ScriptService]
    [System.ComponentModel.ToolboxItem(false)]
    public class TranslationManagement : WebService
    {
        ...
        public object PrepareMetadata(string key, string path, int blocksCount, string fileName, long fileSize, long chunkSize)
        {
            ...
            else
            {
                ...
                return PrepareMetadataResponse("translations", folder, blocksCount, fileName, fileSize, chunkSize, true);
            }
        }
        ...
        private object UploadBlockToBlobStorage(int id, HttpPostedFile uploadedData, FileUploadModel model)
        {
            ...
            CloudBlockBlob blob = container.GetBlockBlobReference((folderName + model.FileName));
            ...
            //Assembly chunks in to single file
            {
                ...
                blob.Metadata["filename"] = HttpUtility.HtmlEncode(model.FileName);
                blob.SetMetadata();
