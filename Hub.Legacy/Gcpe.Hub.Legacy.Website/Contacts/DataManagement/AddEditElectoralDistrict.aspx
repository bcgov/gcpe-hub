<%@ Page Language="C#" AutoEventWireup="true" Inherits="AddEditElectoralDistrict" MasterPageFile="~/Contacts/MasterPage/MediaRelations.master" CodeBehind="AddEditElectoralDistrict.aspx.cs" %>
        ...
        <asp:Panel runat="server" ID="displayPanel">
            ...
            <div class="common-page-box-border">
                ...
                <div class="common-page-box-inner-small manage-data-area">
                    ...
                    <asp:TextBox runat="server" ID="electoralDistrictNameTb" MaxLength="250" />
                ...
                <script type="text/javascript">
                    ...
                    function ConfirmValidPageSubmission() {
                        ...
                        var element = document.getElementById('<%= electoralDistrictNameTb.ClientID %>');
                    var errorElm = document.getElementById('<%= nameError.ClientID %>');

                    errorElm.innerHTML = "";

                    if (element.value.trim() == "") {
                        //alert("Electoral district name cannot be empty");
                        alert(saveErrorText.replace("###errors###", "Electoral District Name\n"));
                        errorElm.innerHTML = "Electoral district name cannot be empty";
                        return false;
                    }
                    return true;
                }
