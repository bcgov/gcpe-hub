<%@ Page Language="C#" AutoEventWireup="true" Inherits="AddEditBeat" MasterPageFile="~/Contacts/MasterPage/MediaRelations.master" CodeBehind="AddEditBeat.aspx.cs" %>
        ...
        <asp:Panel runat="server" ID="displayPanel">
            ...
            <div class="common-page-box-border">
                ...
                <div class="common-page-box-inner-small manage-data-area">
                    ...
                    <asp:TextBox runat="server" ID="beatNameTb" MaxLength="250" />
            ...
            <script type="text/javascript">
                ...
                function ConfirmValidPageSubmission() {
                    ...
                    var element = document.getElementById('<%= beatNameTb.ClientID %>');
                    ...
                    if (element.value.trim() == "") {
                        ...
                        alert(saveErrorText.replace("###errors###", "Beat Name\n"));
                        errorElm.innerHTML = "Beat name cannot be empty";
                        return false;
                    }
                    return true;
                }
