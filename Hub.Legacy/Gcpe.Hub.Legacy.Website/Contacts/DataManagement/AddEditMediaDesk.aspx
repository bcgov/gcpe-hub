<%@ Page Language="C#" AutoEventWireup="true" Inherits="AddEditMediaDesk" MasterPageFile="~/Contacts/MasterPage/MediaRelations.master" CodeBehind="AddEditMediaDesk.aspx.cs" %>
        ...
        <asp:Panel runat="server" ID="displayPanel">
            ...
            <div class="common-page-box-border">
                ...
                <div class="common-page-box-inner-small manage-data-area">
                    ...
                    <asp:TextBox runat="server" ID="mediaDeskNameTb" MaxLength="250" />
            ...
            <script type="text/javascript">
                ...
                function ConfirmValidPageSubmission() {
                    ...
                    var element = document.getElementById('<%= mediaDeskNameTb.ClientID %>');
                    var errorElm = document.getElementById('<%= nameError.ClientID %>');

                    errorElm.innerHTML = "";

                    if (element.value.trim() == "") {
                        //alert("MediaDesk name cannot be empty");
                        alert(saveErrorText.replace("###errors###", "MediaDesk Name\n"));
                        errorElm.innerHTML = "MediaDesk name cannot be empty";
                        return false;
                    }
                    return true;
                }
