<%@ Page Language="C#" AutoEventWireup="true" Inherits="AddEditDistribution" MasterPageFile="~/Contacts/MasterPage/MediaRelations.master" CodeBehind="AddEditDistribution.aspx.cs" %>
        ...
        <asp:Panel runat="server" ID="displayPanel">
            ...
            <div class="common-page-box-border">
                ...
                <div class="common-page-box-inner-small manage-data-area">
                    ...
                    <asp:TextBox runat="server" ID="distributionNameTb" MaxLength="250" />
            ...
            <script type="text/javascript">
                ...
                function ConfirmValidPageSubmission() {
                    ...
                    var element = document.getElementById('<%= distributionNameTb.ClientID %>');
                    var errorElm = document.getElementById('<%= nameError.ClientID %>');

                    errorElm.innerHTML = "";

                    if (element.value.trim() == "") {
                        //alert("Distribution name cannot be empty");
                        alert(saveErrorText.replace("###errors###", "Distribution Name\n"));
                        errorElm.innerHTML = "Distribution name cannot be empty";
                        return false;
                    }
                    return true;
                }
