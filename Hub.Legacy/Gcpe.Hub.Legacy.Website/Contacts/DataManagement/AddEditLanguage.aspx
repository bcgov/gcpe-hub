<%@ Page Language="C#" AutoEventWireup="true" Inherits="AddEditLanguage" MasterPageFile="~/Contacts/MasterPage/MediaRelations.master" CodeBehind="AddEditLanguage.aspx.cs" %>
        ...
        <asp:Panel runat="server" ID="displayPanel">
            ...
            <div class="common-page-box-border">
                ...
                <div class="common-page-box-inner-small manage-data-area">
                    ...
                    <asp:TextBox runat="server" ID="languageNameTb" MaxLength="250" />
            ...
            <script type="text/javascript">
                ...
                function ConfirmValidPageSubmission() {
                    ...
                    var element = document.getElementById('<%= languageNameTb.ClientID %>');
                    ...
                    if (element.value.trim() == "") {
                        ...
                        alert(saveErrorText.replace("###errors###", "Language Name\n"));
                        errorElm.innerHTML = "Language name cannot be empty";
                        return false;
                    }
                    return true;
                }
