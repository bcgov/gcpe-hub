<%@ Page Language="C#" AutoEventWireup="true" Inherits="AddEditPublicationFrequency" MasterPageFile="~/Contacts/MasterPage/MediaRelations.master" CodeBehind="AddEditPublicationFrequency.aspx.cs" %>
        ...
        <asp:Panel runat="server" ID="displayPanel">
            ...
            <div class="common-page-box-border">
                ...
                <div class="common-page-box-inner-small manage-data-area">
                    ...
                    <asp:TextBox runat="server" ID="publicationFrequencyNameTb" MaxLength="250" />
            ...
            <script type="text/javascript">
                ...
                function ConfirmValidPageSubmission() {
                    ...
                    var element = document.getElementById('<%= publicationFrequencyNameTb.ClientID %>');
                    var errorElm = document.getElementById('<%= nameError.ClientID %>');

                    errorElm.innerHTML = "";

                    if (element.value.trim() == "") {
                        //alert("PublicationFrequency name cannot be empty");
                        alert(saveErrorText.replace("###errors###", "PublicationFrequency Name\n"));
                        errorElm.innerHTML = "PublicationFrequency name cannot be empty";
                        return false;
                    }
                    return true;
                }
