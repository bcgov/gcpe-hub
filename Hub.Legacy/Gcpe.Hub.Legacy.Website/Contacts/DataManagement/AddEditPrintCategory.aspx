<%@ Page Language="C#" AutoEventWireup="true" Inherits="AddEditPrintCategory" MasterPageFile="~/Contacts/MasterPage/MediaRelations.master" CodeBehind="AddEditPrintCategory.aspx.cs" %>
        ...
        <asp:Panel runat="server" ID="displayPanel">
            ...
            <div class="common-page-box-border">
                ...
                <div class="common-page-box-inner-small manage-data-area">
                    ...
                    <asp:TextBox runat="server" ID="printCategoryNameTb" MaxLength="250" />
            ...
            <script type="text/javascript">
                ...
                function ConfirmValidPageSubmission() {
                    ...
                    var element = document.getElementById('<%= printCategoryNameTb.ClientID %>');
                    var errorElm = document.getElementById('<%= nameError.ClientID %>');

                    errorElm.innerHTML = "";

                    if (element.value.trim() == "") {
                        //alert("PrintCategory name cannot be empty");
                        alert(saveErrorText.replace("###errors###", "PrintCategory Name\n"));
                        errorElm.innerHTML = "PrintCategory name cannot be empty";
                        return false;
                    }
                    return true;
                }
