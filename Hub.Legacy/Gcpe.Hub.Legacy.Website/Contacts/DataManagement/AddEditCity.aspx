<%@ Page Language="C#" AutoEventWireup="true" Inherits="AddEditCity" MasterPageFile="~/Contacts/MasterPage/MediaRelations.master" CodeBehind="AddEditCity.aspx.cs" %>
        ...
        <asp:Panel runat="server" ID="displayPanel">
            ...
            <div class="common-page-box-border">
                ...
                <div class="common-page-box-inner-small manage-data-area">
                    ...
                    <asp:TextBox runat="server" ID="cityNameTb" MaxLength="250" />
            ...
            <script type="text/javascript">
                ...
                function ConfirmValidPageSubmission() {
                    ...
                    var element = document.getElementById('<%= cityNameTb.ClientID %>');
                    ...
                    if (element.value.trim() == "") {
                        ...
                        alert(saveErrorText.replace("###errors###", "City Name\n"));
                        errorElm.innerHTML = "City name cannot be empty";
                        return false;
                    }
                    return true;
                }
