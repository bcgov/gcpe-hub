<%@ Page Language="C#" AutoEventWireup="true" Inherits="AddEditMediaJobTitle" MasterPageFile="~/Contacts/MasterPage/MediaRelations.master" CodeBehind="AddEditMediaJobTitle.aspx.cs" %>
...
<asp:Panel runat="server" ID="displayPanel">
    ...
    <div class="common-page-box-border">
        ...
        <div class="common-admin-control-bar" runat="server" id="editOnlyDisplayPanel" visible="false">
            ...
            <div class="right">
                <asp:LinkButton Visible="false" runat="server" ID="deleteButton" Text="Delete" OnClick="DeleteClick" OnClientClick="return confirm(deleteButtonText);" /></div>
        </div>

        <div class="common-page-box-inner-small manage-data-area">
            <div class="field labeltop">Name: <span class="required">*</span></div>
            <asp:TextBox runat="server" ID="mediaJobTitleNameTb" MaxLength="250" />
    ...
    <script type="text/javascript">
        ...
        function ConfirmValidPageSubmission() {
            ...
            var element = document.getElementById('<%= mediaJobTitleNameTb.ClientID %>');
            var errorElm = document.getElementById('<%= nameError.ClientID %>');

            errorElm.innerHTML = "";

            if (element.value.trim() == "") {
                //alert("MediaJobTitle name cannot be empty");
                alert(saveErrorText.replace("###errors###", "MediaJobTitle Name\n"));
                errorElm.innerHTML = "MediaJobTitle name cannot be empty";
                return false;
            }
            return true;
        }
