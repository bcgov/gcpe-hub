<%@ Page Language="C#" AutoEventWireup="true" Inherits="AddEditMediaType" MasterPageFile="~/Contacts/MasterPage/MediaRelations.master" CodeBehind="AddEditMediaType.aspx.cs" %>
        ...
        <asp:Panel runat="server" ID="displayPanel">
            ...
            <div class="common-page-box-border">
                ...
                <div class="common-page-box-inner-small manage-data-area">
                    ...
                    <asp:TextBox runat="server" ID="mediaTypeTb" MaxLength="250" />
            ...
            <script type="text/javascript">
                ...
                function ConfirmValidPageSubmission() {
                    ...
                    var element = document.getElementById('<%= mediaTypeTb.ClientID %>');
            var errorElm = document.getElementById('<%= nameError.ClientID %>');

            errorElm.innerHTML = "";

            if (element.value.trim() == "") {
                //alert("Media type name cannot be empty");
                alert(saveErrorText.replace("###errors###", "Media Type\n"));
                errorElm.innerHTML = "Media type name cannot be empty";
                return false;
            }
            return true;
        }
