<%@ Page Language="C#" AutoEventWireup="true" Inherits="AddEditPublicationDay" MasterPageFile="~/Contacts/MasterPage/MediaRelations.master" CodeBehind="AddEditPublicationDay.aspx.cs" %>
        ...
        <asp:Panel runat="server" ID="displayPanel">
            ...
            <div class="common-page-box-border">
                ...
                <div class="common-page-box-inner-small manage-data-area">
                    ...
                    <asp:TextBox runat="server" ID="publicationDayNameTb" MaxLength="250" />
            ...
            <script type="text/javascript">
                ...
                function ConfirmValidPageSubmission() {
                    ...
                    var element = document.getElementById('<%= publicationDayNameTb.ClientID %>');
                    var errorElm = document.getElementById('<%= nameError.ClientID %>');

                    errorElm.innerHTML = "";

                    if (element.value.trim() == "") {
                        //alert("PublicationDay name cannot be empty");
                        alert(saveErrorText.replace("###errors###", "PublicationDay Name\n"));
                        errorElm.innerHTML = "PublicationDay name cannot be empty";
                        return false;
                    }
                    return true;
                }
