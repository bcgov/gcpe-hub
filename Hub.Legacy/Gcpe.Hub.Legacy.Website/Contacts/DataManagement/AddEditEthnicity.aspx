<%@ Page Language="C#" AutoEventWireup="true" Inherits="AddEditEthnicity" MasterPageFile="~/Contacts/MasterPage/MediaRelations.master" CodeBehind="AddEditEthnicity.aspx.cs" %>
        ...
        <asp:Panel runat="server" ID="displayPanel">
            ...
            <div class="common-page-box-border">
                ...
                <div class="common-page-box-inner-small manage-data-area">
                    ...
                    <asp:TextBox runat="server" ID="ethnicityNameTb" MaxLength="250" />
            ...
            <script type="text/javascript">
                ...
                function ConfirmValidPageSubmission() {
                    ...
                    var element = document.getElementById('<%= ethnicityNameTb.ClientID %>');
                    var errorElm = document.getElementById('<%= nameError.ClientID %>');

                    errorElm.innerHTML = "";

                    if (element.value.trim() == "") {
                        //alert("Ethnicity name cannot be empty");
                        alert(saveErrorText.replace("###errors###", "Ethnicity Name\n"));
                        errorElm.innerHTML = "Ethnicity name cannot be empty";
                        return false;
                    }
                    return true;
                }
