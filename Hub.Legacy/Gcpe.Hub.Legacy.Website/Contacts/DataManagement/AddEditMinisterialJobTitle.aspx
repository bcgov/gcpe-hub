<%@ Page Language="C#" AutoEventWireup="true" Inherits="AddEditMinisterialJobTitle" MasterPageFile="~/Contacts/MasterPage/MediaRelations.master" CodeBehind="AddEditMinisterialJobTitle.aspx.cs" %>
        ...
        <asp:Panel runat="server" ID="displayPanel">
            ...
            <div class="common-page-box-border">
                ...
                <div class="common-page-box-inner-small manage-data-area">
                    ...
                    <asp:TextBox runat="server" ID="ministerialJobTitleNameTb" MaxLength="250" />
            ...
            <script type="text/javascript">
                ...
                function ConfirmValidPageSubmission() {
                    ...
                    var element = document.getElementById('<%= ministerialJobTitleNameTb.ClientID %>');
                    var errorElm = document.getElementById('<%= nameError.ClientID %>');

                    errorElm.innerHTML = "";

                    if (element.value.trim() == "") {
                        //alert("MinisterialJobTitle name cannot be empty");
                        alert(saveErrorText.replace("###errors###", "MinisterialJobTitle Name\n"));
                        errorElm.innerHTML = "MinisterialJobTitle name cannot be empty";
                        return false;
                    }
                    return true;
                }
