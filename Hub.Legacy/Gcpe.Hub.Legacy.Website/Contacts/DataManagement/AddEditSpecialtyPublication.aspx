<%@ Page Language="C#" AutoEventWireup="true" Inherits="AddEditSpecialtyPublication" MasterPageFile="~/Contacts/MasterPage/MediaRelations.master" CodeBehind="AddEditSpecialtyPublication.aspx.cs" %>
        ...
        <asp:Panel runat="server" ID="displayPanel">
            ...
            <div class="common-page-box-border">
                ...
                <div class="common-page-box-inner-small manage-data-area">
                    ...
                    <asp:TextBox runat="server" ID="specialtyPublicationNameTb" MaxLength="250" />
            ...
            <script type="text/javascript">
                ...
                function ConfirmValidPageSubmission() {
                    ...
                    var element = document.getElementById('<%= specialtyPublicationNameTb.ClientID %>');
                    var errorElm = document.getElementById('<%= nameError.ClientID %>');

                    errorElm.innerHTML = "";

                    if (element.value.trim() == "") {
                        //alert("SpecialtyPublication name cannot be empty");
                        alert(saveErrorText.replace("###errors###", "SpecialtyPublication Name\n"));
                        errorElm.innerHTML = "SpecialtyPublication name cannot be empty";
                        return false;
                    }
                    return true;
                }
