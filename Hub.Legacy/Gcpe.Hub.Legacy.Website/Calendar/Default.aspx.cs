...
namespace Gcpe.Hub.Calendar
{
    public partial class Default : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            string[] hiddenColumns = customPrincipal.HiddenColumns != null ? customPrincipal.HiddenColumns.Split(',') : new[] { "1", "2", "3" };
            ActivityGrid.ColModel = colModel;
            //Create the columns for the Grid.
            int i = 0;
            colModel.Add(new ColumnModel("Activity Id", "MinistryActivityId", 7, true, HorizontalAlign.Right, hiddenColumns, i++));
            ...
            colModel.Add(new ColumnModel("Status", "Status", 5, true, HorizontalAlign.Left, hiddenColumns, i++));
