...
function onQuestionClick(helpLinkElement, openLeft) {
    ...
    var helpFilePath = 'ContextualHelp/';
    ...
    var fieldsetHeight = parentFieldset[0].clientHeight;
    var topOfFieldset = parentFieldset[0].offsetTop;
    var bottomOfFieldset = parentFieldset[0].offsetTop + parentFieldset.outerHeight(true);
    helpDiv.load(helpFilePath, function () {
        ...
        //}
        var topOfHelp = topOfFieldset;
        //to make sure the bottom edge of the help box doesn't disappear
        var bottomOfHelp = topOfHelp + helpDivHeight;
