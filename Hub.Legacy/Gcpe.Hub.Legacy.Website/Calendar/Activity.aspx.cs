...
namespace Gcpe.Hub.Calendar
{
    public partial class Activity : System.Web.UI.Page
    {
        ...
        static string[] defaultTranslations = { "TBD", "None", "Arabic", "Chinese (Simplified)", "Chinese (Traditional)", "Dutch", "Farsi", "Finnish", "French", "Gujarati", "Hebrew", "Hindi", "Indonesian", "Japanese", "Korean", "Portuguese", "Punjabi", "Russian", "Somali", "Spanish", "Swahili", "Tagalog", "Ukrainian", "Urdu", "Vietnamese" };
