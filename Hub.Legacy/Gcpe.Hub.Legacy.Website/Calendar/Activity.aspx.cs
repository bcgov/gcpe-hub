...
namespace Gcpe.Hub.Calendar
{
    public partial class Activity : System.Web.UI.Page
    {
        ...
        static string[] defaultTranslations = { "Arabic", "Chinese (Simplified)", "Chinese (Traditional)", "Dutch", "Farsi", "French", "Gujarati", "Hebrew", "Hindi", "Indonesian", "Japanese", "Korean", "Punjabi", "Russian", "Somali", "Spanish", "Swahili", "Tagalog", "Ukrainian", "Urdu", "Vietnamese" };
