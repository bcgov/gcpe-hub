CREATE TABLE [calendar].[Activity] (
    ...
    [Translations]                NVARCHAR (500)   NULL,
    [StatusId]                    INT              NULL,
    [HqStatusId]                  INT              NULL,
    ...
    [IsSignificanceNeedsReview] BIT NOT NULL DEFAULT ((0)), 
    [IsStrategyNeedsReview] BIT NOT NULL DEFAULT ((0)), 
    [IsSchedulingConsiderationsNeedsReview] BIT NOT NULL DEFAULT ((0)), 
    [IsInternalNotesNeedsReview] BIT NOT NULL DEFAULT ((0)), 
    [IsLeadOrganizationNeedsReview] BIT NOT NULL DEFAULT ((0)), 
    [IsInitiativesNeedsReview] BIT NOT NULL DEFAULT ((0)), 
    [IsTagsNeedsReview] BIT NOT NULL DEFAULT ((0)), 
    [IsOriginNeedsReview] BIT NOT NULL DEFAULT ((0)), 
    [IsDistributionNeedsReview] BIT NOT NULL DEFAULT ((0)), 
    [IsTranslationsRequiredNeedsReview] BIT NOT NULL DEFAULT ((0)), 
    [IsPremierRequestedNeedsReview] BIT NOT NULL DEFAULT ((0)), 
    [IsVenueNeedsReview] BIT NOT NULL DEFAULT ((0)), 
    [IsEventPlannerNeedsReview] BIT NOT NULL DEFAULT ((0)), 
    [IsDigitalNeedsReview] BIT NOT NULL DEFAULT ((0)), 
